---
title: why PISA is difficult to analyze
...
# Why is it difficult to analyze PISA data?
...
SCIE<-pisa2006 %>% group_by(CNT) %>% summarise(Mean=(weighted.mean(PV4SCIE,W_FSTUWT, na.rm=TRUE)))
Merge<-inner_join(PVSCIE, SCIE, by="CNT")
head(Merge,15)
```
